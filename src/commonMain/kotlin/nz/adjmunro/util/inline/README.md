...
- Default parameter function references ([`ResultExt.kt`](https://github.com/adjmunro/kotlin-utils/blob/main/src/main/kotlin/nz/adjmunro/util/inline/ReturnExt.kt), [`StringExt.kt`](https://github.com/adjmunro/kotlin-utils/blob/main/src/main/kotlin/nz/adjmunro/util/inline/StringExt.kt))
- If-else for function chains to bisect and recombine logic ([`FoldExt.kt`](https://github.com/adjmunro/kotlin-utils/blob/main/src/main/kotlin/nz/adjmunro/util/inline/FoldExt.kt))
- Type-casting facilities for function chains ([`CastExt.kt`](https://github.com/adjmunro/kotlin-utils/blob/main/src/main/kotlin/nz/adjmunro/util/inline/CastExt.kt))
