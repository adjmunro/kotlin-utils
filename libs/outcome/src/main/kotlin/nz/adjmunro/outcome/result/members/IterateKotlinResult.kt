...
/**
 * - ***If all*** [results][nz.adjmunro.outcome.result.KotlinResult] in the [Iterable] are [success][Result.isSuccess],
 *   `returns` a new [nz.adjmunro.outcome.result.KotlinResult] success, with a [List] of each element's encapsulated value.
 * - ***If any*** [results][nz.adjmunro.outcome.result.KotlinResult] in the [Iterable] are [failure][Result.isFailure],
 *   `returns` a new [nz.adjmunro.outcome.result.KotlinResult] failure with the result of the [reduce] function.
 */
@KotlinResultDsl
